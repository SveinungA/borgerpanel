...
Deltakere som ikke oppfyller disse kravene oppfordres til å ta direkte kontakt med representanter for Bergen kommune.
...
Medlem <- tibble(Involverte = c('Jacob', 'Sveinung', 'Anne Lise', 'Fageksperter', 'Hvem fra kommunen?'))
kable(Medlem)
```
