...
<!-- Veien var imidlertid lang før vi landet på disse to temaene, og man bør være forberedt på at denne prosessen kan ta tid. -->
<!-- Derfor er det viktig å bruke god tid i denne første fasen, som ellers ikke er så intensiv med tanke på rent praktiske oppgaver. -->
...
Undersøkelsen kan du lese mer om i kapittel \@ref(demokratiundersøkelsen-2020)
...
```{r metode}
Medlem <- tibble(Involverte = c('Jim', 'Alice', 'Jacob', 'Anne Lise', 'Henrik', 'Jon Kåre', 'Sveinung', 'Richard', 'Pål'))
kable(Medlem)
```
...
#### Programvare: Stanford Online Deliberation Platform
...
Fram til nå har SODP-teamet vært tett på hver enkelt gjennomføring av online deliberativ meningsmåling, og det vil de også være i vårt tilfelle.
Alice Siu, Lodewijk Gelauff, og en person til vil være med under selve gjennomføringen av den deliberative meningsmålingen.
...
*	Fremheve positive og negative sider ved DM i kontrast til de andre formene for medvirkning

*	Se Mansbridge 

*	Alternativer til DM

*	Political forums with deliberative elements are being instituted across the globe (ref first chapter + several chapters in handbook)

*	Deliberative Mini-Publics

*	Citizen dialogue (https://participedia.net/method/631)

*	Planleggingscelle (se side 67 i rapport)

*	Borgerjury (se side 68 i rapport)
