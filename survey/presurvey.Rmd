...
Noen mener dette er bra siden det blir lettere for folk å ikke eie egen bil. Det kan også frigi fellesarealer til andre aktiviteter i nabolaget, ettersom det blir behov for færre parkeringsplasser når ikke alle trenger sin egen bil.
...
Likevel finnes det tiltak som kan redusere biltrafikken, og vi ber deg indikere hvilken måte du foretrekker av de to under:

- Privatbilisme tillatt, med maksfart på 10 km/t.
...
- Fysiske hindringer: For eksempel stolper i veien som kan senkes for nødvendig trafikk.
Tiltaket er mer sikkert enn fartsgrense med tanke på lek i nabolag. 
Det er positivt for nærmiljø og andre trafikanter enn kjørende, og oppnår bilfrie soner på bestemte tidspunkt.
Samtidig vil fysiske hindringer ha en betydelig høyere økonomisk kostnad enn andre alternativer. 
...
> Merkelapp: Elsparkesykler

Noen mener elsparkesykler bør forbys på fortau, da de er en fare for gående. Andre mener elsparkesykler er nyttige framkomstmidler som bør ha samme betingelser som vanlige sykler.
...
Noen foretrekker å kunne gå til skole, matbutikk, offentlige grøntområder, og kollektivtilbud på under 10 minutter å gå, selv om det betyr at de har bilparkering mer enn 250 meter fra boligen. 
Andre foretrekker å ha bilparkering like ved boligen, selv om det betyr at det er mer enn 10 minutter å gå til grøntområder, men over 10 minutter å gå til skole, matbutikk og kollektivtilbud.
...
-	De bilfrie sonene bør være større områder, som bydelssentre
...
Hvor viktig var følgende argumenter for din holdning til om de bilfrie sonene bør være større områder, som bydelssentre?

```{r presurvey-forslag3-bilfri}

table <- tibble(Argumenter = c('Tiltakene med å legge til rette for sykling og gange vil komme flere til gode',
                ...
                'Folk trenger bil for å komme seg til bydelssentrene, så det blir ikke fritt for biler uansett.',
